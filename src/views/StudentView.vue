  ...
  <v-container fluid class="pa-4">
          ...
          <div class="d-flex flex-column flex-md-row align-center justify-space-between">
            <div class="page-title-section mb-4 mb-md-0">
              <h1 class="page-title text-h4 font-weight-bold mb-2">
                <v-icon icon="mdi-account-school-outline" class="mr-3" color="primary"></v-icon>
                Student Management
              </h1>
              <p class="page-subtitle text-body-1 text-medium-emphasis">
                Manage student profiles, qualifications, and assignments
              </p>
            </div>
    ...
    <v-row class="mb-4">
      <v-col cols="12" md="8" lg="6">
        <v-text-field v-model="search" prepend-inner-icon="mdi-magnify" label="Search students..." variant="outlined"
      ...
      <v-col cols="12" md="4" lg="6" class="d-flex justify-end align-center">
        <v-chip v-if="students.length > 0" color="primary" variant="tonal" prepend-icon="mdi-account-group">
          ...
          <v-data-table :headers="headers" :search="search" :items="students" :items-length="totalItems"
            ...
            <template v-slot:item.actions="{ item }">
              <div class="action-buttons-cell justify-end">
                ...
                <v-tooltip text="Delete Student" location="top">
                  <template v-slot:activator="{ props }">
            ...
            <v-row>
              ...
              <v-col cols="12" md="6">
                <v-select v-model="editedItem.grade_uuid" :items="gradeOptions" item-title="displayText"
                  item-value="value" label="Select Grade" variant="outlined" prepend-inner-icon="mdi-star"
                  clearable></v-select>
              </v-col>
        ...
        <v-card-text class="pa-6">
          ...
          <div class="text-center">
            ...
            <p class="text-body-1 mb-4">
              You're about to delete student
