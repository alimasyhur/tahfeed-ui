                  ...
                  <v-container>
                    ...
                    <v-form v-model="form" @submit.prevent="save">
                      <v-row>
                        ...
                        <v-col cols="12">
                          <v-text-field v-model="editedItem.type_report" :rules="required" label="Type" type="text"
                            :loading="loading" clearable></v-text-field>
                        </v-col>
                        <v-col cols="12">
                        ...
                        <v-col cols="12" md="6">
                          <v-select v-model="selectedStartJuz" :items="juzOptions" item-title="displayText"
                            item-value="value" label="Select Juz" @change="onJuzChange" />
                        </v-col>

                        <v-col cols="12" md="6">
                          <v-select v-model="selectedStartPage" :items="pageOptions" item-title="displayText"
                            item-value="value" label="Select Page" :disabled="!selectedStartJuz"
                            @change="onPageChange" />
                        </v-col>
                        ...
                        <v-col cols="12" md="6">
                          <v-select v-model="selectedEndJuz" :items="juzOptions" item-title="displayText"
                            ...
                            @change="onJuzEndChange" />
                        </v-col>

                        <v-col cols="12" md="6">
                          <v-select v-model="selectedEndPage" :items="pageOptions" item-title="displayText"
                            item-value="value" label="Select Page" :disabled="!selectedEndJuz" @change="onPageChange" />
                        </v-col>
                      </v-row>
                      <v-row>
                        <v-col>
